...
public class ItemApiController {
	...
	@PostMapping("/item")
	public ResponseEntity<Long> create(@RequestBody ItemCreateRequestDTO request) {
		return itemService.create(request);
	}
	
	@PutMapping("/item/{id}")
	public ResponseEntity<Long> update(@PathVariable Long id, @RequestBody ItemUpdateRequestDTO request) {
